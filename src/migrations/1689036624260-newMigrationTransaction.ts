...
export class NewMigrationTransaction1689036624260 implements MigrationInterface {
    name = 'NewMigrationTransaction1689036624260'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "transaction" ADD CONSTRAINT "FK_59c844d96a0248b1f7b0946a58b" FOREIGN KEY ("cardId") REFERENCES "card"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
